...
uses
	Evas,EvasEngineBuffer;

//crt,logger

//same BGI basics apply here- this is demo code- it is more work due to BGICore not being implemented
...
//function create_canvas(width,height:integer):EvasPtr;
//procedure destroy_canvas(canvas:EvasPtr);
//procedure draw_scene(canvas:EvasPtr);
//procedure save_scene(canvas:EvasPtr,const dest:Pchar);
//implementation
...
begin
   ...
   writeln('initial scene, with just background:');
   draw_scene(canvas);
   ...
   writeln('final scene (note updates): ');
   draw_scene(canvas);
