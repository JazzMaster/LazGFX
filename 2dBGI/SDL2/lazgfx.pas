...
{
A "fully creative rewrite" of the "Borland Graphic Interface" in SDL (c) 2014-2019 Guido Gonzato, PhD and
...
Updated to support FreePascal/Lazarus by Richard Jasmin
...
The C is in a rough portage state but this unit in general -builds, compiles, and runs
without problems.

Previous demos had a SDL exit glitch. This has been fixed.
